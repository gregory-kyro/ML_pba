...
def train_sgcnn(data_dir, train_data, val_data, checkpoint_dir, load_checkpoint_bool=False, load_checkpoint_path = None):
    """
    ...
    5) load_checkpoint_bool: boolean flag for whether to start training from a prior checkpoint (False by default)
    6) load_checkpoint_path: path to checkpoint file to load from (default is None)
    ...
    def checkpoint_model(model, dataloader, epoch, step):
        ...
        torch.save(checkpoint_dict, checkpoint_dir + '/sgcnn_checkpoint.pt')
